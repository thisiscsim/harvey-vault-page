  ...
  return (
    <AnimatePresence>
      {selectedCount > 0 && (
        ...
        >
          <div className="bg-button-inverted text-fg-on-color rounded-lg shadow-2xl flex items-center gap-1 w-max" style={{ padding: '4px' }}>
            {/* Selection count and clear button */}
            <button
              onClick={onClearSelection}
              className="flex items-center gap-2 px-3 py-1.5 hover:bg-button-inverted-hover active:bg-button-inverted-pressed rounded-[6px] transition-colors"
            >
            ...
            {/* Vertical divider */}
            <div className="w-px bg-button-inverted-hover" style={{ height: '16px' }} />
