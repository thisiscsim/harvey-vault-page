...
export default {
  ...
  theme: {
    extend: {
      fontFamily: {
        sans: ['Harvey Sans', 'ui-sans-serif', 'system-ui', 'sans-serif'],
      ...
      colors: {
        neutral: {
          ...
          920: 'rgb(var(--neutral-920) / <alpha-value>)',
          930: 'rgb(var(--neutral-930) / <alpha-value>)',
          940: 'rgb(var(--neutral-940) / <alpha-value>)',
